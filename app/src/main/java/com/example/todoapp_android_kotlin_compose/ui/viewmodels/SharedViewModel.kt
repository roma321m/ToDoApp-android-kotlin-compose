...
import com.example.todoapp_android_kotlin_compose.data.repositories.DataStoreRepository
...
class SharedViewModel @Inject constructor(
    ...
    var searchAppBarState by mutableStateOf(CLOSED)
        private set
    ...
    val lowPriorityTasks: StateFlow<List<ToDoTask>> = repository.sortByLowPriority
        .stateIn(
    ...
    val highPriorityTasks: StateFlow<List<ToDoTask>> = repository.sortByHighPriority
        .stateIn(
            scope = viewModelScope,
            started = SharingStarted.WhileSubscribed(),
            emptyList()
