...
import com.example.todoapp_android_kotlin_compose.util.Constants.ITEM_ANIMATION_TIME_MILLIS
    ...
    LazyColumn(modifier = modifier) {
        items(
            ...
            if (isDismissed && dismissDirection == DismissDirection.EndToStart) {
                ...
                scope.launch {
                    delay(ITEM_ANIMATION_TIME_MILLIS.toLong())
            ...
            AnimatedVisibility(
                ...
                enter = expandVertically(
                    animationSpec = tween(
                        durationMillis = ITEM_ANIMATION_TIME_MILLIS
                    )
                ),
